...
(function(t, n) {
    ...
    function e(t, n, e) {
        var r = Math.abs(n - t) / Math.max(0, e),
            ...
            o = r / i;
        return o >= Ds ? i *= 10 : o >= Os ? i *= 5 : o >= Fs && (i *= 2), n < t ? -i : i
    }
    ...
    function m(t) {
        return 1 - Math.cos(t * wf)
    }

    function x(t) {
        return Math.sin(t * wf)
    }

    function b(t) {
        return (1 - Math.cos(bf * t)) / 2
    }
    ...
    function E(t) {
        return (t = +t) < Mf ? Pf * t * t : t < Nf ? Pf * (t -= Tf) * t + kf : t < Af ? Pf * (t -= Sf) * t + Ef : Pf * (t -= Cf) * t + zf
    }
    ...
    function P(t) {
        for (var n = t.length, e = [0, 1], r = 2, i = 2; i < n; ++i) {
            for (; r > 1 && Xf(t[e[r - 2]], t[e[r - 1]], t[i]) <= 0;) --r;
            e[r++] = i
        }
        return e.slice(0, r)
    }
    ...
    function X(t) {
        for (; t._start = t._waiting && t._active < t._size;) {
            var n = t._ended + t._active,
                ...
                r = e.length - 1,
                i = e[r];
            e[r] = V(t, n), --t._waiting, ++t._active, e = i.apply(null, e), t._tasks[n] && (t._tasks[n] = e || dl)
        }
    }
    ...
    function nt(t) {
        return t >= 1 ? gl : t <= -1 ? -gl : Math.asin(t)
    }
    ...
    function Bt(t) {
        var n;
        return t = (t + "").trim().toLowerCase(), (n = Th.exec(t)) ? (n = parseInt(n[1], 16), new Wt(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, (15 & n) << 4 | 15 & n, 1)) : (n = Nh.exec(t)) ? jt(parseInt(n[1], 16)) : (n = kh.exec(t)) ? new Wt(n[1], n[2], n[3], 1) : (n = Sh.exec(t)) ? new Wt(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, 1) : (n = Ah.exec(t)) ? Ht(n[1], n[2], n[3], n[4]) : (n = Eh.exec(t)) ? Ht(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4]) : (n = Ch.exec(t)) ? $t(n[1], n[2] / 100, n[3] / 100, 1) : (n = zh.exec(t)) ? $t(n[1], n[2] / 100, n[3] / 100, n[4]) : Ph.hasOwnProperty(t) ? jt(Ph[t]) : "transparent" === t ? new Wt(NaN, NaN, NaN, 0) : null
    }
    ...
    function Kt(t) {
        ...
        var e = un(t.r),
            r = un(t.g),
            i = un(t.b),
            o = en((.4124564 * e + .3575761 * r + .1804375 * i) / Uh),
            u = en((.2126729 * e + .7151522 * r + .072175 * i) / Dh),
            a = en((.0193339 * e + .119192 * r + .9503041 * i) / Oh);
    ...
    function en(t) {
        return t > Bh ? Math.pow(t, 1 / 3) : t / Yh + Fh
    }

    function rn(t) {
        return t > Ih ? t * t * t : Yh * (t - Fh)
    }
    ...
    function fn(t) {
        ...
        var n = t.r / 255,
            e = t.g / 255,
            r = t.b / 255,
            i = (Gh * r + $h * n - Zh * e) / (Gh + $h - Zh),
            o = r - i,
            u = (Wh * (e - i) - Xh * o) / Vh,
            a = Math.sqrt(u * u + o * o) / (Wh * i * (1 - i)),
            c = a ? Math.atan2(u, o) * Lh - 120 : NaN;
    ...
    function _n(t, n) {
        var e = n - t;
        return e ? dn(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e) : rp(isNaN(t) ? n : t)
    }

    function yn(t) {
        return 1 === (t = +t) ? gn : function(n, e) {
            return e - n ? vn(n, e, t) : rp(isNaN(n) ? e : n)
        }
    }

    function gn(t, n) {
        var e = n - t;
        return e ? dn(t, e) : rp(isNaN(t) ? n : t)
    }
    ...
    function wn(t) {
        return "none" === t ? yp : (Jh || (Jh = document.createElement("DIV"), Qh = document.documentElement, Kh = document.defaultView), Jh.style.transform = t, t = Kh.getComputedStyle(Qh.appendChild(Jh), null).getPropertyValue("transform"), Qh.removeChild(Jh), t = t.slice(7, -1).split(","), gp(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
    }

    function Mn(t) {
        return null == t ? yp : (tp || (tp = document.createElementNS("http://www.w3.org/2000/svg", "g")), tp.setAttribute("transform", t), (t = tp.transform.baseVal.consolidate()) ? (t = t.matrix, gp(t.a, t.b, t.c, t.d, t.e, t.f)) : yp)
    }
    ...
    function Un(t, n, e) {
        for (var r = 0, i = t.length; r < i; ++r)
            if (t[r].name === n) {
                t[r] = qp, t = t.slice(0, r).concat(t.slice(r + 1));
                break
            }
    ...
    function Wn() {
        jn(), ++ed;
        for (var t, n = Lp; n;)(t = ad - n._time) >= 0 && n._call.call(null, t), n = n._next;
        --ed
    }

    function $n() {
        ad = (ud = sd.now()) + cd, ed = rd = 0;
        try {
            Wn()
        } finally {
            ed = 0, Gn(), ad = 0
    ...
    function Gn() {
        for (var t, n, e = Lp, r = 1 / 0; e;) e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : Lp = n);
        Rp = t, Jn(r)
    }

    function Jn(t) {
        if (!ed) {
            rd && (rd = clearTimeout(rd));
            var n = t - ad;
            n > 24 ? (t < 1 / 0 && (rd = setTimeout($n, n)), id && (id = clearInterval(id))) : (id || (id = setInterval(Zn, od)), ed = 1, fd($n))
        }
    }
    ...
    function Qn(t, n, e, r) {
        ...
        return i.floor = i, i.ceil = function(e) {
            ...
            return pd.setTime(+n), dd.setTime(+r), t(pd), t(dd), Math.floor(e(pd, dd))
        }, i.every = function(t) {
    ...
    function Kn(t) {
        return Qn(function(n) {
            ...
            return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * gd) / bd
        })
    }
    ...
    function ne(t) {
        if (!(n = kv.exec(t))) throw new Error("invalid format: " + t);
        var n, e = n[1] || " ",
            r = n[2] || ">",
            i = n[3] || "-",
            o = n[4] || "",
            ...
            s = n[8] && +n[8].slice(1),
            f = n[9] || "";
        "n" === f ? (c = !0, f = "g") : Nv[f] || (f = ""), (u || "0" === e && "=" === r) && (u = !0, e = "0", r = "="), this.fill = e, this.align = r, this.sign = i, this.symbol = o, this.zero = u, this.width = a, this.comma = c, this.precision = s, this.type = f
    }
    ...
    function re(n) {
        return Av = Cv(n), t.format = Av.format, t.formatPrefix = Av.formatPrefix, Av
    }
        ...
        function n(t, n) {
            return function(e) {
                var r, i, o, u = [],
                    ...
                    c = 0,
                    s = t.length;
                for (e instanceof Date || (e = new Date(+e)); ++a < s;) 37 === t.charCodeAt(a) && (u.push(t.slice(c, a)), null != (i = Rv[r = t.charAt(++a)]) ? r = t.charAt(++a) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), u.push(r), c = a + 1);
        ...
        function r(t, n, e, r) {
            for (var i, o, u = 0, a = n.length, c = e.length; u < a;) {
                ...
                if (i = n.charCodeAt(u++), 37 === i) {
                    if (i = n.charAt(u++), o = B[i in Rv ? n.charAt(u++) : i], !o || (r = o(t, e, r)) < 0) return -1
    ...
    function he(t, n, e) {
        var r = Uv.exec(n.slice(e, e + 1));
        return r ? (t.w = +r[0], e + r[0].length) : -1
    }

    function pe(t, n, e) {
        var r = Uv.exec(n.slice(e));
    ...
    function ve(t, n, e) {
        var r = Uv.exec(n.slice(e, e + 4));
        return r ? (t.y = +r[0], e + r[0].length) : -1
    }

    function _e(t, n, e) {
        var r = Uv.exec(n.slice(e, e + 2));
    ...
    function Ee(t, n) {
        return ce(1 + Ad.count(Vd(t), t), n, 3)
    }
    ...
    function je(t, n) {
        return ce(1 + Qd.count(_v(t), t), n, 3)
    }
    ...
    function nr(n) {
        return zv = ae(n), t.timeFormat = zv.format, t.timeParse = zv.parse, t.utcFormat = zv.utcFormat, t.utcParse = zv.utcParse, zv
    }
    ...
    function ir(t) {
        ...
        var e = o(),
            r = [],
            i = Xv;
        return t = null == t ? [] : Hv.call(t), n.domain = function(t) {
            if (!arguments.length) return r.slice();
            r = [], e = o();
            for (var i, u, a = -1, c = t.length; ++a < c;) e.has(u = (i = t[a]) + "") || e.set(u, r.push(i));
            return n
        }, n.range = function(e) {
            return arguments.length ? (t = Hv.call(e), n) : t.slice()
    ...
    function dr(t, n) {
        ...
        return r.invert = function(t) {
            ...
            return arguments.length ? (a = jv.call(t, Wv), e()) : a.slice()
        }, r.range = function(t) {
            return arguments.length ? (c = Hv.call(t), e()) : c.slice()
        }, r.rangeRound = function(t) {
            return c = Hv.call(t), s = vp, e()
        }, r.clamp = function(t) {
    ...
    function vr(t) {
        ...
        return t.ticks = function(t) {
            var e = n();
            return Is(e[0], e[e.length - 1], null == t ? 10 : t)
    ...
    function yr() {
        ...
        return t.invert = t, t.domain = t.range = function(e) {
            return arguments.length ? (n = jv.call(e, Wv), t) : n.slice()
        }, t.copy = function() {
            return yr().domain(n)
        }, vr(t)
    }
    ...
    function Tr() {
        ...
        return e.base = function(t) {
            ...
            } else v = Is(h, p, Math.min(p - h, d)).map(u);
    ...
    function Ar() {
        function t() {
            ...
            for (i = new Array(o - 1); ++t < o;) i[t - 1] = js(e, t / o);
            return n
        }

        function n(t) {
            if (!isNaN(t = +t)) return r[Ts(i, t)]
        }
        var e = [],
            r = [],
            i = [];
        return n.invertExtent = function(t) {
            ...
            return arguments.length ? (r = Hv.call(n), t()) : r.slice()
    ...
    function Er() {
        ...
        return t.domain = function(t) {
            ...
            return arguments.length ? (i = (u = Hv.call(t)).length - 1, n()) : u.slice()
    ...
    function Cr() {
        function t(t) {
            if (t <= t) return e[Ts(n, t, 0, r)]
        }
        var n = [.5],
            e = [0, 1],
            r = 1;
        return t.domain = function(i) {
            return arguments.length ? (n = Hv.call(i), r = Math.min(n.length, e.length - 1), t) : n.slice()
        }, t.range = function(i) {
            return arguments.length ? (e = Hv.call(i), r = Math.min(n.length, e.length - 1), t) : e.slice()
        }, t.invertExtent = function(t) {
            var r = e.indexOf(t);
            return [n[r - 1], n[r]]
        }, t.copy = function() {
    ...
    function qr(t, n, r, i, o, u, a, c, s) {
        ...
        function l(n, r, i, o) {
            if (null == n && (n = 10), "number" == typeof n) {
                ...
                a === M.length ? (o = e(r / r_, i / r_, n), n = t) : a ? (a = M[u / M[a - 1][2] < M[a][2] / u ? a - 1 : a], o = a[1], n = a[0]) : (o = e(r, i, n), n = c)
            }
        ...
        return h.invert = function(t) {
            ...
            return arguments.length ? d(jv.call(t, Pr)) : d().map(zr)
            ...
            var e = d();
            return (t = l(t, e[0], e[e.length - 1], n)) ? d(Gv(e, t)) : h
        }, h.copy = function() {
    ...
    function Ur(t) {
        return function() {
            var n = this.ownerDocument,
                e = this.namespaceURI;
            return e === x_ && n.documentElement.namespaceURI === x_ ? n.createElement(t) : n.createElementNS(e, t)
        }
    }
    ...
    function Hr(t, n, e) {
        var r = E_.hasOwnProperty(t.type) ? Ir : Yr;
    ...
    function Gr(t, n, e, r, i, o, u) {
        var a, c, s, f = {},
            ...
            h = o.length,
            p = new Array(l);
        for (a = 0; a < l; ++a)(c = n[a]) && (p[a] = s = j_ + u.call(c, c.__data__, a, n), s in f ? i[a] = c : f[s] = c);
        for (a = 0; a < h; ++a) s = j_ + u.call(t, o[a], a, o), (c = f[s]) ? (r[a] = c, c.__data__ = o[a], f[s] = null) : e[a] = new $r(t, o[a]);
    ...
    function Ui(t, n, e) {
        function r(t) {
            e.state = My, e.timer.restart(i, e.delay, e.time), e.delay <= t && i(t - e.delay)
        }

        function i(r) {
            var s, f, l, h;
            if (e.state !== My) return u();
            for (s in c)
                if (h = c[s], h.name === e.name) {
                    if (h.state === Ny) return ld(i);
                    h.state === ky ? (h.state = Ay, h.timer.stop(), h.on.call("interrupt", t, t.__data__, h.index, h.group), delete c[s]) : +s < n && (h.state = Ay, h.timer.stop(), delete c[s])
                }
            if (ld(function() {
                    e.state === Ny && (e.state = ky, e.timer.restart(o, e.delay, e.time), o(r))
                }), e.state = Ty, e.on.call("start", t, t.__data__, e.index, e.group), e.state === Ty) {
                for (e.state = Ny, a = new Array(l = e.tween.length), s = 0, f = -1; s < l; ++s)(h = e.tween[s].value.call(t, t.__data__, e.index, e.group)) && (a[++f] = h);
                a.length = f + 1
            }
        }

        function o(n) {
            for (var r = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(u), e.state = Sy, 1), i = -1, o = a.length; ++i < o;) a[i].call(null, r);
            e.state === Sy && (e.on.call("end", t, t.__data__, e.index, e.group), u())
        }

        function u() {
            e.state = Ay, e.timer.stop(), delete c[n];
    ...
    function eo(t, n) {
        var e, r, i;
        return function() {
            var o = ey(this).getComputedStyle(this, null),
    ...
    function io(t, n, e) {
        var r, i;
        return function() {
            var o = ey(this).getComputedStyle(this, null).getPropertyValue(t);
            return o === e ? null : o === r ? i : i = n(r = o, e)
        }
    }
    ...
    function oo(t, n, e) {
        var r, i, o;
        return function() {
            var u = ey(this).getComputedStyle(this, null),
    ...
    function ho(t, n) {
        for (var e; !(e = t.__transition) || !(e = e[n]);)
            if (!(t = t.parentNode)) return Ky.time = jn(), Ky;
        return e
    }
    ...
    function go(t, n) {
        function e(e) {
            var s, f = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i,
                l = null == o ? n.tickFormat ? n.tickFormat.apply(n, r) : ig : o,
                h = Math.max(u, 0) + c,
                p = t === og || t === ag ? po : vo,
                d = n.range(),
                v = d[0] + .5,
                _ = d[d.length - 1] + .5,
                y = (n.bandwidth ? _o : ig)(n.copy()),
                ...
                T = x.select("text"),
                N = t === og || t === cg ? -1 : 1,
                k = t === cg || t === ug ? (s = "x", "y") : (s = "y", "x");
            m = m.merge(m.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "#000")), x = x.merge(w), M = M.merge(w.append("line").attr("stroke", "#000").attr(s + "2", N * u).attr(k + "1", .5).attr(k + "2", .5)), T = T.merge(w.append("text").attr("fill", "#000").attr(s, N * h).attr(k, .5).attr("dy", t === og ? "0em" : t === ag ? "0.71em" : "0.32em")), e !== g && (m = m.transition(e), x = x.transition(e), M = M.transition(e), T = T.transition(e), b = b.transition(e).attr("opacity", sg).attr("transform", function(t) {
                return p(y, this.parentNode.__axis || y, t)
            }), w.attr("opacity", sg).attr("transform", function(t) {
                return p(this.parentNode.__axis || y, y, t)
            })), b.remove(), m.attr("d", t === cg || t == ug ? "M" + N * a + "," + v + "H0.5V" + _ + "H" + N * a : "M" + v + "," + N * a + "V0.5H" + _ + "V" + N * a), x.attr("opacity", 1).attr("transform", function(t) {
                return p(y, y, t)
            }), M.attr(s + "2", N * u), T.attr(s, N * h).text(l), g.filter(yo).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === ug ? "start" : t === cg ? "end" : "middle"), g.each(function() {
                this.__axis = y
            })
        }
        var r = [],
        ...
        return e.scale = function(t) {
            ...
            return r = rg.call(arguments), e
        }, e.tickArguments = function(t) {
            return arguments.length ? (r = null == t ? [] : rg.call(t), e) : r.slice()
        }, e.tickValues = function(t) {
            return arguments.length ? (i = null == t ? null : rg.call(t), e) : i && i.slice()
    ...
    function Wo(t) {
        ...
        for (r = wg(n), a = 0; a < i; ++a) n = t[a], n.x -= r.x, n.y -= r.y;
        return r.r
    }
    ...
    function lu(t, n, e, r, i, o) {
        for (var u, a, c, s, f, l, h, p, d, v, _, y, g = [], m = n.children, x = 0, b = m.length, w = n.value; x < b;) {
            ...
            }), u.dice ? Sg(u, e, r, i, w ? r += f * l / w : o) : Lg(u, e, r, w ? e += s * l / w : i, o), w -= l, x = c
        }
        return g
    }
    ...
    function mu(t, n) {
        var e = t.document.documentElement,
            r = _y(t).on("dragstart.drag", null);
        n && (r.on("click.drag", Qg, !0), setTimeout(function() {
    ...
    function zu(t, n, e, r) {
        var i = [null, null],
            o = am.push(i) - 1;
        return i.left = t, i.right = n, e && qu(i, t, n, e), r && qu(i, n, t, r), om[t.index].halfedges.push(o), om[n.index].halfedges.push(o), i
    }
    ...
    function Uu(t, n, e, r) {
        for (var i, o = am.length; o--;) Ru(i = am[o], t, n, e, r) && Lu(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > fm || Math.abs(i[0][1] - i[1][1]) > fm) || delete am[o]
    }
    ...
    function Yu() {
        for (var t, n, e, r, i = 0, o = om.length; i < o; ++i)
            if ((t = om[i]) && (r = (n = t.halfedges).length)) {
                var u = new Array(r),
                    a = new Array(r);
                for (e = 0; e < r; ++e) u[e] = e, a[e] = Ou(t, am[n[e]]);
    ...
    function Bu(t, n, e, r) {
        var i, o, u, a, c, s, f, l, h, p, d, v, _ = om.length,
            y = !0;
        for (i = 0; i < _; ++i)
            if (o = om[i]) {
                for (u = o.site, c = o.halfedges, a = c.length; a--;) am[c[a]] || c.splice(a, 1);
                for (a = 0, s = c.length; a < s;) p = Iu(o, am[c[a]]), d = p[0], v = p[1], f = Fu(o, am[c[++a % s]]), l = f[0], h = f[1], (Math.abs(d - l) > fm || Math.abs(v - h) > fm) && (c.splice(a, 0, am.push(Pu(u, p, Math.abs(d - t) < fm && r - v > fm ? [t, Math.abs(l - t) < fm ? h : r] : Math.abs(v - r) < fm && e - d > fm ? [Math.abs(h - r) < fm ? l : e, r] : Math.abs(d - e) < fm && v - n > fm ? [e, Math.abs(l - e) < fm ? h : n] : Math.abs(v - n) < fm && d - t > fm ? [Math.abs(h - n) < fm ? l : t, n] : null)) - 1), ++s);
                s && (y = !1)
            }
        if (y) {
            var g, m, x, b = 1 / 0;
            for (i = 0, y = null; i < _; ++i)(o = om[i]) && (u = o.site, g = u[0] - t, m = u[1] - n, x = g * g + m * m, x < b && (b = x, y = o));
            if (y) {
                var w = [t, n],
                    M = [t, r],
                    T = [e, r],
                    N = [e, n];
                y.halfedges.push(am.push(Pu(u = y.site, w, M)) - 1, am.push(Pu(u, M, T)) - 1, am.push(Pu(u, T, N)) - 1, am.push(Pu(u, N, w)) - 1)
            }
        }
        for (i = 0; i < _; ++i)(o = om[i]) && (o.halfedges.length || delete om[i])
    }
    ...
    function Xu(t) {
        var n = t.circle;
        n && (n.P || (rm = n.N), um.remove(n), cm.push(n), Su(n), t.circle = null)
    }
    ...
    function $u(t) {
        Xu(t), im.remove(t), sm.push(t), Su(t)
    }
    ...
    function Zu(t) {
        var n = t.circle,
            ...
            a = [t];
        $u(t);
        for (var c = o; c.circle && Math.abs(e - c.circle.x) < fm && Math.abs(r - c.circle.cy) < fm;) o = c.P, a.unshift(c), $u(c), c = o;
        a.unshift(c), Xu(c);
        for (var s = u; s.circle && Math.abs(e - s.circle.x) < fm && Math.abs(r - s.circle.cy) < fm;) u = s.N, a.push(s), $u(s), s = u;
        a.push(s), Xu(s);
        var f, l = a.length;
        for (f = 1; f < l; ++f) s = a[f], c = a[f - 1], qu(s.edge, c.site, s.site, i);
        c = a[0], s = a[l - 1], s.edge = zu(c.site, s.site, null, i), Hu(c), Hu(s)
    }

    function Gu(t) {
        for (var n, e, r, i, o = t[0], u = t[1], a = im._; a;)
            if (r = Ju(a, u) - o, r > fm) a = a.L;
            else {
                if (i = o - Qu(a, u), !(i > fm)) {
                    r > -fm ? (n = a.P, e = a) : i > -fm ? (n = a, e = a.N) : n = e = a;
                    break
                }
                if (!a.R) {
                    n = a;
        ...
        Du(t);
        var c = Wu(t);
        if (im.insert(n, c), n || e) {
            if (n === e) return Xu(n), e = Wu(n.site), im.insert(c, e), c.edge = e.edge = zu(n.site, c.site), Hu(n), void Hu(e);
    ...
    function na(t, n) {
        ...
        for (am = [], om = new Array(t.length), im = new ku, um = new ku;;)
            if (i = rm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Gu(o), e = o[0], r = o[1]), o = t.pop();
            else {
                if (!i) break;
                Zu(i.arc)
            }
        ...
        this.edges = am, this.cells = om, im = um = am = om = null
    }
    ...
    function ga(n) {
        function e(t) {
            ...
            e.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", Sm.overlay).merge(e).each(function() {
                var t = pa(this).extent;
                _y(this).attr("x", t[0][0]).attr("y", t[0][1]).attr("width", t[1][0] - t[0][0]).attr("height", t[1][1] - t[0][1])
            }), t.selectAll(".selection").data([fa("selection")]).enter().append("rect").attr("class", "selection").attr("cursor", Sm.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");
        ...
        function u() {
            function e() {
                var t = L_(T);
                !U || w || M || (Math.abs(t[0] - O[0]) > Math.abs(t[1] - O[1]) ? M = !0 : w = !0), O = t, b = !0, mm(), o()
            }
            ...
            function o() {
                ...
                _ < h && (S *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, N in Am && Y.attr("cursor", Sm[N = Am[N]])), g < d && (A *= -1, t = p, p = y, y = t, t = d, d = g, g = t, N in Em && Y.attr("cursor", Sm[N = Em[N]])), E.selection && (z = E.selection), w && (h = z[0][0], _ = z[1][0]), M && (d = z[0][1], g = z[1][1]), z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === g || (E.selection = [
                    [h, d],
                    [_, g]
                ], r.call(T), F.brush())
            }
            ...
            function u() {
                ...
                I.attr("pointer-events", "all"), Y.attr("cursor", Sm.overlay), E.selection && (z = E.selection), da(z) && (E.selection = null, r.call(T)), F.end()
            }
            ...
            function a() {
                switch (t.event.keyCode) {
                    case 16:
                        ...
                        break;
                    case 18:
                        k === wm && (S && (v = _ - m * S, l = h + m * S), A && (y = g - x * A, p = d + x * A), k = Mm, o());
                        break;
                    case 32:
                        k !== wm && k !== Mm || (S < 0 ? v = _ - m : S > 0 && (l = h - m), A < 0 ? y = g - x : A > 0 && (p = d - x), k = bm, Y.attr("cursor", Sm.selection), o());
                        break;
                    default:
                        return
                }
            ...
            function s() {
                switch (t.event.keyCode) {
                    case 16:
                        ...
                        break;
                    case 18:
                        k === Mm && (S < 0 ? v = _ : S > 0 && (l = h), A < 0 ? y = g : A > 0 && (p = d), k = wm, o());
                        break;
                    case 32:
                        k === bm && (t.event.altKey ? (S && (v = _ - m * S, l = h + m * S), A && (y = g - x * A, p = d + x * A), k = Mm) : (S < 0 ? v = _ : S > 0 && (l = h), A < 0 ? y = g : A > 0 && (p = d), k = wm), Y.attr("cursor", Sm[N]), o());
                        break;
                    default:
                        return
                }
            ...
            if (t.event.touches) {
                if (t.event.changedTouches.length < t.event.touches.length) return mm()
            } else if (c) return;
            if (f.apply(this, arguments)) {
                var l, h, p, d, v, _, y, g, m, x, b, w, M, T = this,
                    N = t.event.target.__data__.type,
                    k = "selection" === (t.event.metaKey ? N = "overlay" : N) ? xm : t.event.altKey ? Mm : wm,
                    S = n === Nm ? null : Cm[N],
                    A = n === Tm ? null : zm[N],
                    E = pa(T),
                    C = E.extent,
                ...
                "overlay" === N ? E.selection = z = [
                    [l = n === Nm ? P : D[0], p = n === Tm ? q : D[1]],
                    [v = n === Nm ? L : l, y = n === Tm ? R : p]
                ] : (l = z[0][0], p = z[0][1], v = z[1][0], y = z[1][1]), h = l, d = p, _ = v, g = y;
                var I = _y(T).attr("pointer-events", "none"),
                    Y = I.selectAll(".overlay").attr("cursor", Sm[N]);
                if (t.event.touches) I.on("touchmove.brush", e, !0).on("touchend.brush touchcancel.brush", u, !0);
                else {
                    var B = _y(t.event.view).on("keydown.brush", a, !0).on("keyup.brush", s, !0).on("mousemove.brush", e, !0).on("mouseup.brush", u, !0);
                    Kg(t.event.view)
                }
                sa(), Cy(T), r.call(T), F.start()
            }
        }
        ...
        return e.move = function(t, e) {
            t.selection ? t.on("start.brush", function() {
                ...
                var t = this,
                    ...
                    c = i(t, o).beforestart();
                Cy(t), u.selection = null == a || da(a) ? null : a, r.call(t), c.start().brush().end()
            })
        }, o.prototype = {
            ...
            emit: function(t) {
                Xr(new gm(e, t, n.output(this.state.selection)), l.apply, l, [t, this.that, this.args])
            }
        }, e.extent = function(t) {
            return arguments.length ? (s = "function" == typeof t ? t : ym([
                [+t[0][0], +t[0][1]],
                [+t[1][0], +t[1][1]]
            ]), e) : s
        }, e.filter = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : ym(!!t), e) : f
    ...
    function Sa(t) {
        return t > 1 ? 0 : t < -1 ? Tx : Math.acos(t)
    }

    function Aa(t) {
        return t > 1 ? Nx : t < -1 ? -Nx : Math.asin(t)
    }
    ...
    function za(t, n) {
        t && jx.hasOwnProperty(t.type) && jx[t.type](t, n)
    }
    ...
    function Ua(t, n) {
        Wx.point = Da, Hm = t, Xm = n, t *= Ex, n *= Ex, Vm = t, Wm = qx(n = n / 2 + kx), $m = Ox(n)
    }
    ...
    function Da(t, n) {
        ...
        var e = t - Vm,
            ...
            c = Wm * o + a * qx(i),
            s = a * r * Ox(i);
        Xx.add(Px(s, c)), Vm = t, Wm = o, $m = u
    }

    function Oa(t) {
        return [Px(t[1], t[0]), Aa(t[2])]
    }
    ...
    function Ha(t) {
        var n = Ix(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);
        t[0] /= n, t[1] /= n, t[2] /= n
    }

    function Xa(t, n) {
        rx.push(ix = [Zm = t, Jm = t]), n < Gm && (Gm = n), n > Qm && (Qm = n)
    }
    ...
    function Va(t, n) {
        ...
        if (ex) {
            ...
            var u, a = t - Km,
                ...
                s = o[0] * Ax * c,
                f = Cx(a) > 180;
            f ^ (c * Km < s && s < c * t) ? (u = o[1] * Ax, u > Qm && (Qm = u)) : (s = (s + 360) % 360 - 180, f ^ (c * Km < s && s < c * t) ? (u = -o[1] * Ax, u < Gm && (Gm = u)) : (n < Gm && (Gm = n), n > Qm && (Qm = n))), f ? t < Km ? Qa(Zm, t) > Qa(Zm, Jm) && (Jm = t) : Qa(t, Jm) > Qa(Zm, Jm) && (Zm = t) : Jm >= Zm ? (t < Zm && (Zm = t), t > Jm && (Jm = t)) : t > Km ? Qa(Zm, t) > Qa(Zm, Jm) && (Jm = t) : Qa(t, Jm) > Qa(Zm, Jm) && (Zm = t)
        } else Xa(t, n);
        ex = e, Km = t
    }
    ...
    function $a() {
        ix[0] = Zm, ix[1] = Jm, Gx.point = Xa, ex = null
    }

    function Za(t, n) {
        if (ex) {
            var e = t - Km;
            Zx.add(Cx(e) > 180 ? e + (e > 0 ? 360 : -360) : e)
        } else tx = t, nx = n;
        Wx.point(t, n), Va(t, n)
    }
    ...
    function Ja() {
        Za(tx, nx), Wx.lineEnd(), Cx(Zx) > wx && (Zm = -(Jm = 180)), ix[0] = Zm, ix[1] = Jm, ex = null
    }
    ...
    function nc(t, n) {
        t *= Ex, n *= Ex;
        var e = qx(n);
        ec(e * qx(t), e * Ox(t), Ox(n))
    }

    function ec(t, n, e) {
        ++ox, ax += (t - ax) / ox, cx += (n - cx) / ox, sx += (e - sx) / ox
    }
    ...
    function ic(t, n) {
        t *= Ex, n *= Ex;
        var e = qx(n);
        gx = e * qx(t), mx = e * Ox(t), xx = Ox(n), Qx.point = oc, ec(gx, mx, xx)
    }
    ...
    function oc(t, n) {
        ...
        var e = qx(n),
            ...
            i = e * Ox(t),
            o = Ox(n),
            u = Px(Ix((u = mx * o - xx * i) * u + (u = xx * r - gx * o) * u + (u = gx * i - mx * r) * u), gx * r + mx * i + xx * o);
        ux += u, fx += u * (gx + (gx = r)), lx += u * (mx + (mx = i)), hx += u * (xx + (xx = o)), ec(gx, mx, xx)
    }
    ...
    function cc() {
        fc(_x, yx), Qx.point = nc
    }

    function sc(t, n) {
        _x = t, yx = n, t *= Ex, n *= Ex, Qx.point = fc;
        var e = qx(n);
        gx = e * qx(t), mx = e * Ox(t), xx = Ox(n), ec(gx, mx, xx)
    }
    ...
    function fc(t, n) {
        ...
        var e = qx(n),
            ...
            l = s && -Sa(f) / s,
            h = Px(s, f);
        px += l * u, dx += l * a, vx += l * c, ux += h, fx += h * (gx + (gx = r)), lx += h * (mx + (mx = i)), hx += h * (xx + (xx = o)), ec(gx, mx, xx)
    }

    function lc(t, n) {
        return [t > Tx ? t - Sx : t < -Tx ? t + Sx : t, n]
    }

    function hc(t, n, e) {
        return (t %= Sx) ? n || e ? nb(dc(t), vc(n, e)) : dc(t) : n || e ? vc(n, e) : lc
    }

    function pc(t) {
        return function(n, e) {
            return n += t, [n > Tx ? n - Sx : n < -Tx ? n + Sx : n, e]
        }
    }
    ...
    function vc(t, n) {
        function e(t, n) {
            var e = qx(n),
                ...
                s = Ox(n),
                f = s * r + a * i;
            return [Px(c * o - f * u, a * r - s * i), Aa(f * o + c * u)]
        }
        var r = qx(t),
            i = Ox(t),
            o = qx(n),
        ...
        return e.invert = function(t, n) {
            var e = qx(n),
                ...
                s = Ox(n),
                f = s * o - c * u;
            return [Px(c * o + s * u, a * r + f * i), Aa(f * r - a * i)]
        }, e
    }
    ...
    function _c(t, n, e, r, i, o) {
        if (e) {
            var u = qx(n),
                a = Ox(n),
                c = r * e;
            null == i ? (i = n + r * Sx, o = n - c / 2) : (i = yc(u, i), o = yc(u, o), (r > 0 ? i < o : i > o) && (i += r * Sx));
            for (var s, f = i; r > 0 ? f > o : f < o; f -= c) s = Oa([u, -a * qx(f), -a * Ox(f)]), t.point(s[0], s[1])
        }
    }
    ...
    function xc(t, n, e, r) {
        ...
        function u(r, i) {
            return Cx(r[0] - t) < wx ? i > 0 ? 0 : 3 : Cx(r[0] - e) < wx ? i > 0 ? 2 : 1 : Cx(r[1] - n) < wx ? i > 0 ? 1 : 0 : i > 0 ? 3 : 2
        }
        ...
        return function(u) {
            ...
            function l() {
                var t = s(),
                    n = N && t,
                    e = (v = Zs(v)).length;
                (n || e) && (u.polygonStart(), n && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), e && gb(v, a, t, o, u), u.polygonEnd()), k = u, v = _ = y = null
            }
            ...
            function d(o, u) {
                ...
                if (_ && y.push([o, u]), T) g = o, m = u, x = a, T = !1, a && (k.lineStart(), k.point(o, u));
                    ...
                    var c = [b = Math.max(xb, Math.min(mb, b)), w = Math.max(xb, Math.min(mb, w))],
                        s = [o = Math.max(xb, Math.min(mb, o)), u = Math.max(xb, Math.min(mb, u))];
                    _b(c, s, t, n, e, r) ? (M || (k.lineStart(), k.point(c[0], c[1])), k.point(s[0], s[1]), a || k.lineEnd(), N = !1) : a && (k.lineStart(), k.point(o, u), N = !1)
                }
                b = o, w = u, M = a
            }
    ...
    function bc() {
        Mb.point = Mc, Mb.lineEnd = wc
    }

    function wc() {
        Mb.point = Mb.lineEnd = Ca
    }

    function Mc(t, n) {
        t *= Ex, n *= Ex, eb = t, rb = Ox(n), ib = qx(n), Mb.point = Tc
    }
    ...
    function Tc(t, n) {
        ...
        var e = Ox(n),
            ...
            c = ib * e - rb * r * o,
            s = rb * e + ib * r * o;
        wb.add(Px(Ix(a * a + c * c), s)), eb = t, rb = e, ib = r
    }

    function Nc(t, n, e) {
        var r = Us(t, n - wx, e).concat(n);
        return function(t) {
    ...
    function Ac(t, n) {
        qb.point = Ec, ob = ab = t, ub = cb = n
    }

    function Ec(t, n) {
        Pb.add(cb * t - ab * n), ab = t, cb = n
    }
    ...
    function zc(t, n) {
        t < Lb && (Lb = t), t > Ub && (Ub = t), n < Rb && (Rb = n), n > Db && (Db = n)
    }
    ...
    function Rc(t, n) {
        var e = t - lb,
            r = n - hb,
            i = Ix(e * e + r * r);
        Bb += i * (lb + t) / 2, jb += i * (hb + n) / 2, Hb += i, Pc(lb = t, hb = n)
    }
    ...
    function Ic(t, n) {
        var e = t - lb,
            r = n - hb,
            i = Ix(e * e + r * r);
        Bb += i * (lb + t) / 2, jb += i * (hb + n) / 2, Hb += i, i = hb * t - lb * n, Xb += i * (lb + t), Vb += i * (hb + n), Wb += 3 * i, Pc(lb = t, hb = n)
    }
    ...
    function Xc(t, n) {
        return ((t = t.x)[0] < 0 ? t[1] - Nx - wx : Nx - t[1]) - ((n = n.x)[0] < 0 ? n[1] - Nx - wx : Nx - n[1])
    }
    ...
    function Vc(t) {
        ...
        return {
            ...
            point: function(o, u) {
                var a = o > 0 ? Tx : -Tx,
                    c = Cx(o - e);
                Cx(c - Tx) < wx ? (t.point(e, r = (r + u) / 2 > 0 ? Nx : -Nx), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), n = 0) : i !== a && c >= Tx && (Cx(e - i) < wx && (e -= i * wx), Cx(o - a) < wx && (o -= a * wx), r = Wc(e, r, o, u), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), n = 0), t.point(e = o, r = u), i = a
            },
            lineEnd: function() {
                t.lineEnd(), e = r = NaN
            },
    ...
    function Wc(t, n, e, r) {
        var i, o, u = Ox(t - e);
        return Cx(u) > wx ? zx((Ox(n) * (o = qx(r)) * Ox(e) - Ox(r) * (i = qx(n)) * Ox(t)) / (i * o * u)) : (n + r) / 2
    }

    function $c(t, n, e, r) {
        var i;
        if (null == t) i = e * Nx, r.point(-Tx, i), r.point(0, i), r.point(Tx, i), r.point(Tx, 0), r.point(Tx, -i), r.point(0, -i), r.point(-Tx, -i), r.point(-Tx, 0), r.point(-Tx, i);
        else if (Cx(t[0] - n[0]) > wx) {
            var o = t[0] < n[0] ? Tx : -Tx;
    ...
    function Zc(t) {
        function n() {}
        var e = n.prototype = Object.create(Gc.prototype);
    ...
    function Jc(t, n, e) {
        ...
        t.scale(150).translate([0, 0]), null != o && t.clipExtent(null), Hx(e, t.stream(Ob));
        var u = Ob.result(),
        ...
        function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
            ...
            if (m > 4 * n && v--) {
                var x = u + h,
                    ...
                    M = Ix(x * x + b * b + w * w),
                    T = Aa(w /= M),
                    N = Cx(Cx(w) - 1) < wx || Cx(o - l) < wx ? (o + l) / 2 : Px(b, x),
                    k = t(N, T),
                    S = k[0],
                    A = k[1],
                    E = S - r,
                    C = A - i,
                    z = g * E - y * C;
                (z * z / m > n || Cx((y * E + g * C) / m - .5) > .3 || u * h + a * p + c * d < rw) && (e(r, i, o, u, a, c, S, A, N, x /= M, b /= M, w, v, _), _.point(S, A), e(S, A, N, x, b, w, s, f, l, h, p, d, v, _))
            }
        }
        return function(n) {
            function r(e, r) {
            ...
            function o(r, i) {
                var o = Fa([r, i]),
                    u = t(r, i);
                e(y, g, _, m, x, b, y = u[0], g = u[1], _ = r, m = o[0], x = o[1], b = o[2], ew, n), n.point(y, g)
            }
            ...
            function s() {
                e(y, g, _, m, x, b, l, h, f, p, d, v, ew, n), w.lineEnd = u, u()
            }
    ...
    function rs(t) {
        function n(t) {
            return t = f(t[0] * Ex, t[1] * Ex), [t[0] * _ + a, c - t[1] * _]
        }

        function e(t) {
            return t = f.invert((t[0] - a) / _, (c - t[1]) / _), t && [t[0] * Ax, t[1] * Ax]
        }
        ...
        return n.stream = function(t) {
                return d && v === t ? d : d = ow(N(s, E(S(v = t))))
            }, n.clipAngle = function(t) {
                return arguments.length ? (N = +t ? tw(T = t * Ex, 6 * Ex) : (T = null, Kb), o()) : T * Ax
            }, n.clipExtent = function(t) {
                return arguments.length ? (S = null == t ? (k = l = h = p = null, Cb) : xc(k = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == k ? null : [
                    [k, l],
                    [h, p]
                ]
            }, n.scale = function(t) {
                ...
                return arguments.length ? (m = t[0] % 360 * Ex, x = t[1] % 360 * Ex, i()) : [m * Ax, x * Ax]
            }, n.rotate = function(t) {
                return arguments.length ? (b = t[0] % 360 * Ex, w = t[1] % 360 * Ex, M = t.length > 2 ? t[2] % 360 * Ex : 0, i()) : [b * Ax, w * Ax, M * Ax]
            }, n.precision = function(t) {
                return arguments.length ? (E = iw(r, A = t * t), o()) : Ix(A)
            }, n.fitExtent = Kc(n), n.fitSize = Qc(n),
            function() {
    ...
    function is(t) {
        ...
        return i.parallels = function(t) {
            return arguments.length ? r(n = t[0] * Ex, e = t[1] * Ex) : [n * Ax, e * Ax]
        }, i
    }
    ...
    function us(t, n) {
        function e(t, n) {
            var e = Ix(o - 2 * i * Ox(n)) / i;
            return [e * Ox(t *= i), u - e * qx(t)]
        }
        var r = Ox(t),
            i = (r + Ox(n)) / 2;
        if (Cx(i) < wx) return os(t);
        var o = 1 + r * (2 * i - r),
            u = Ix(o) / i;
        return e.invert = function(t, n) {
            var e = u - n;
            return [Px(t, Cx(e)) / i * Fx(e), Aa((o - (t * t + e * e) * i * i) / (2 * i))]
        }, e
    }
    ...
    function ss(t) {
        return function(n, e) {
            var r = Ix(n * n + e * e),
                ...
                o = Ox(i),
                u = qx(i);
            return [Px(n * o, r * u), Aa(r && e * o / r)]
        }
    }

    function fs(t, n) {
        return [t, Ux(Yx((Nx + n) / 2))]
    }
    ...
    function ps(t, n) {
        function e(t, n) {
            o > 0 ? n < -Nx + wx && (n = -Nx + wx) : n > Nx - wx && (n = Nx - wx);
            var e = o / Dx(hs(n), i);
            return [e * Ox(i * t), o - e * qx(i * t)]
        }
        var r = qx(t),
            i = t === n ? Ox(t) : Ux(r / qx(n)) / Ux(hs(n) / hs(t)),
            o = r * Dx(hs(t), i) / i;
        return i ? (e.invert = function(t, n) {
            var e = o - n,
                r = Fx(i) * Ix(t * t + e * e);
            return [Px(t, Cx(e)) / i * Fx(e), 2 * zx(Dx(o / r, 1 / i)) - Nx]
        }, e) : fs
    }
    ...
    function vs(t, n) {
        function e(t, n) {
            var e = o - n,
                r = i * t;
            return [e * Ox(r), o - e * qx(r)]
        }
        var r = qx(t),
            i = t === n ? Ox(t) : (r - qx(n)) / (n - t),
            o = r / i + t;
        return Cx(i) < wx ? ds : (e.invert = function(t, n) {
            var e = o - n;
            return [Px(t, Cx(e)) / i * Fx(e), o - Fx(i) * Ix(t * t + e * e)]
        }, e)
    }
    ...
    function _s(t, n) {
        var e = qx(n),
            r = qx(t) * e;
        return [e * Ox(t) / r, Ox(n) / r]
    }

    function ys(t, n) {
        return [qx(n) * Ox(t), Ox(n)]
    }
    ...
    var xs = "4.2.8",
        ...
        As = function(t, n) {
            var e, r, i = t.length,
                ...
                c = 0;
            if (null == n)
                for (; ++a < i;) isNaN(e = Ss(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o));
            else
                for (; ++a < i;) isNaN(e = Ss(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
            if (c > 1) return u / (c - 1)
        },
        Es = function(t, n) {
            var e = As(t, n);
        ...
        Is = function(t, n, r) {
            var i = e(t, n, r);
            return Us(Math.ceil(t / i) * i, Math.floor(n / i) * i + i / 2, i)
        },
        Ys = function(t) {
        ...
        Bs = function() {
            ...
            return t.value = function(e) {
                return arguments.length ? (n = "function" == typeof e ? e : Ls(e), t) : n
            }, t.domain = function(n) {
                return arguments.length ? (e = "function" == typeof n ? n : Ls([n[0], n[1]]), t) : e
            }, t.thresholds = function(n) {
                return arguments.length ? (r = "function" == typeof n ? n : Ls(Array.isArray(n) ? Ps.call(n) : n), t) : r
            }, t
        },
        js = function(t, n, e) {
            if (null == e && (e = Ss), r = t.length) {
        ...
        Hs = function(t, n, e) {
            return t = qs.call(t, Ss).sort(bs), Math.ceil((e - n) / (2 * (js(t, .75) - js(t, .25)) * Math.pow(t.length, -1 / 3)))
        },
        Xs = function(t, n, e) {
            return Math.ceil((e - n) / (3.5 * Es(t) * Math.pow(t.length, -1 / 3)))
        },
        Vs = function(t, n) {
            var e, r, i = -1,
                o = t.length;
        ...
        Ws = function(t, n) {
            var e, r = 0,
                ...
                u = i;
            if (null == n)
                for (; ++o < i;) isNaN(e = Ss(t[o])) ? --u : r += e;
            else
                for (; ++o < i;) isNaN(e = Ss(n(t[o], o, t))) ? --u : r += e;
            if (u) return r / u
        },
        $s = function(t, n) {
            var e, r = [],
                ...
                o = -1;
            if (null == n)
                for (; ++o < i;) isNaN(e = Ss(t[o])) || r.push(e);
            else
                for (; ++o < i;) isNaN(e = Ss(n(t[o], o, t))) || r.push(e);
            return js(r.sort(bs), .5)
        },
        Zs = function(t) {
        ...
        Ks = function(t, n) {
            if (e = t.length) {
                var e, r, i = 0,
                    o = 0,
                    u = t[o];
                for (n || (n = bs); ++i < e;)(n(r = t[i], u) < 0 || 0 !== n(u, u)) && (u = r, o = i);
        ...
        ef = function(t) {
            ...
            for (var n = -1, e = Gs(t, r), i = new Array(e); ++n < e;)
    ...
    i.prototype = o.prototype = {
        ...
        clear: function() {
            for (var t in this) t[0] === of && delete this[t]
        },
        keys: function() {
            var t = [];
            for (var n in this) n[0] === of && t.push(n.slice(1));
            return t
        },
        values: function() {
            var t = [];
            for (var n in this) n[0] === of && t.push(this[n]);
            return t
        },
        entries: function() {
            var t = [];
            for (var n in this) n[0] === of && t.push({
                key: n.slice(1),
                value: this[n]
            });
            return t
        ...
        each: function(t) {
            for (var n in this) n[0] === of && t(this[n], n.slice(1), this)
        }
    };
    var uf = function() {
            function t(n, i, u, a) {
    ...
    var cf = function(t) {
        ...
        If = function t(n, e) {
            ...
            var i = Math.asin(1 / (n = Math.max(1, n))) * (e /= Df);
    ...
    q.prototype = L.prototype = {
            ...
            if (null === this._x1) this._.push("M", this._x1 = t, ",", this._y1 = n);
                ...
                if (Math.abs(f * a - c * s) > Jf && i) {
                    var h = e - o,
                        ...
                        _ = Math.sqrt(d),
                        y = Math.sqrt(l),
                        g = i * Math.tan((Zf - Math.acos((d + l - v) / (2 * _ * y))) / 2),
                        m = g / y,
                        x = g / _;
                    Math.abs(m - 1) > Jf && this._.push("L", t + m * s, ",", n + m * f), this._.push("A", i, ",", i, ",0,0,", +(f * h > s * p), ",", this._x1 = t + x * a, ",", this._y1 = n + x * c)
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            null === this._x1 ? this._.push("M", c, ",", s) : (Math.abs(this._x1 - c) > Jf || Math.abs(this._y1 - s) > Jf) && this._.push("L", c, ",", s), e && (l > Qf ? this._.push("A", e, ",", e, ",0,1,", f, ",", t - u, ",", n - a, "A", e, ",", e, ",0,1,", f, ",", this._x1 = c, ",", this._y1 = s) : (l < 0 && (l = l % Gf + Gf), this._.push("A", e, ",", e, ",0,", +(l >= Zf), ",", f, ",", this._x1 = t + e * Math.cos(i), ",", this._y1 = n + e * Math.sin(i))))
        },
    ...
    var Kf = function(t) {
        ...
        il = function(t, n, e) {
            var r, i, o, u, a, c, s, f = this._x0,
                ...
                d = [],
                v = this._root;
            for (v && d.push(new rl(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop();)
                if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l))
                    if (v.length) {
                        var _ = (i + u) / 2,
                            y = (o + a) / 2;
                        d.push(new rl(v[3], _, y, u, a), new rl(v[2], i, y, _, a), new rl(v[1], _, o, u, y), new rl(v[0], i, o, _, y)), (s = (n >= y) << 1 | t >= _) && (c = d[d.length - 1], d[d.length - 1] = d[d.length - 1 - s], d[d.length - 1 - s] = c)
                    } else {
        ...
        cl = function(t) {
            var n, e, r, i, o, u, a = [],
                c = this._root;
            for (c && a.push(new rl(c, this._x0, this._y0, this._x1, this._y1)); n = a.pop();)
                if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, u = n.y1) && c.length) {
                    var s = (r + o) / 2,
                        f = (i + u) / 2;
                    (e = c[3]) && a.push(new rl(e, s, f, o, u)), (e = c[2]) && a.push(new rl(e, r, f, s, u)), (e = c[1]) && a.push(new rl(e, s, i, o, f)), (e = c[0]) && a.push(new rl(e, r, i, s, f))
                }
            return this
        },
        sl = function(t) {
            var n, e = [],
                r = [];
            for (this._root && e.push(new rl(this._root, this._x0, this._y0, this._x1, this._y1)); n = e.pop();) {
                var i = n.node;
                if (i.length) {
                    var o, u = n.x0,
                        a = n.y0,
                        ...
                        f = (u + c) / 2,
                        l = (a + s) / 2;
                    (o = i[0]) && e.push(new rl(o, u, a, f, l)), (o = i[1]) && e.push(new rl(o, f, a, c, l)), (o = i[2]) && e.push(new rl(o, u, l, f, s)), (o = i[3]) && e.push(new rl(o, f, l, c, s))
                }
                r.push(n)
            }
    ...
    hl.copy = function() {
        ...
        return e
    }, hl.add = Kf, hl.addAll = U, hl.cover = tl, hl.data = nl, hl.extent = el, hl.find = il, hl.remove = ol, hl.removeAll = D, hl.root = ul, hl.size = al, hl.visit = cl, hl.visitAfter = sl, hl.x = fl, hl.y = ll;
    var pl = [].slice,
        dl = {};
        ...
        xl = function() {
            function t() {
                var t, s, f = +n.apply(this, arguments),
                    ...
                    h = o.apply(this, arguments) - gl,
                    p = u.apply(this, arguments) - gl,
                    d = Math.abs(p - h),
                    v = p > h;
                if (c || (c = t = L()), l < f && (s = l, l = f, f = s), l > _l)
                    if (d > ml - _l) c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > _l && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v));
                    else {
                        var _, y, g = h,
                            m = p,
                            x = h,
                            ...
                            N = T > _l && (i ? +i.apply(this, arguments) : Math.sqrt(f * f + l * l)),
                        ...
                        if (N > _l) {
                            var E = nt(N / f * Math.sin(T)),
                                C = nt(N / l * Math.sin(T));
                            (w -= 2 * E) > _l ? (E *= v ? 1 : -1, x += E, b -= E) : (w = 0, x = b = (h + p) / 2), (M -= 2 * C) > _l ? (C *= v ? 1 : -1, g += C, m -= C) : (M = 0, g = m = (h + p) / 2)
                        }
                        var z = l * Math.cos(g),
                            P = l * Math.sin(g),
                            q = f * Math.cos(b),
                        ...
                        if (k > _l) {
                            var U = l * Math.cos(m),
                                ...
                                F = f * Math.sin(x);
                            if (d < yl) {
                                var I = w > _l ? et(z, P, O, F, U, D, q, R) : [q, R],
                                    Y = z - I[0],
                                    B = P - I[1],
                                    j = U - I[0],
                                    H = D - I[1],
                        ...
                        M > _l ? A > _l ? (_ = rt(O, F, z, P, l, A, v), y = rt(U, D, q, R, l, A, v), c.moveTo(_.cx + _.x01, _.cy + _.y01), A < k ? c.arc(_.cx, _.cy, A, Math.atan2(_.y01, _.x01), Math.atan2(y.y01, y.x01), !v) : (c.arc(_.cx, _.cy, A, Math.atan2(_.y01, _.x01), Math.atan2(_.y11, _.x11), !v), c.arc(0, 0, l, Math.atan2(_.cy + _.y11, _.cx + _.x11), Math.atan2(y.cy + y.y11, y.cx + y.x11), !v), c.arc(y.cx, y.cy, A, Math.atan2(y.y11, y.x11), Math.atan2(y.y01, y.x01), !v))) : (c.moveTo(z, P),
                            c.arc(0, 0, l, g, m, !v)) : c.moveTo(z, P), f > _l && w > _l ? S > _l ? (_ = rt(q, R, U, D, f, -S, v), y = rt(z, P, O, F, f, -S, v), c.lineTo(_.cx + _.x01, _.cy + _.y01), S < k ? c.arc(_.cx, _.cy, S, Math.atan2(_.y01, _.x01), Math.atan2(y.y01, y.x01), !v) : (c.arc(_.cx, _.cy, S, Math.atan2(_.y01, _.x01), Math.atan2(_.y11, _.x11), !v), c.arc(0, 0, f, Math.atan2(_.cy + _.y11, _.cx + _.x11), Math.atan2(y.cy + y.y11, y.cx + y.x11), v), c.arc(y.cx, y.cy, S, Math.atan2(y.y11, y.x11), Math.atan2(y.y01, y.x01), !v))) : c.arc(0, 0, f, b, x, v) : c.lineTo(q, R)
                    }
                else c.moveTo(0, 0);
            ...
            return t.centroid = function() {
                var t = (+n.apply(this, arguments) + +e.apply(this, arguments)) / 2,
                    r = (+o.apply(this, arguments) + +u.apply(this, arguments)) / 2 - yl / 2;
                return [Math.cos(r) * t, Math.sin(r) * t]
            }, t.innerRadius = function(e) {
                return arguments.length ? (n = "function" == typeof e ? e : vl(+e), t) : n
            }, t.outerRadius = function(n) {
                return arguments.length ? (e = "function" == typeof n ? n : vl(+n), t) : e
            }, t.cornerRadius = function(n) {
                return arguments.length ? (r = "function" == typeof n ? n : vl(+n), t) : r
            }, t.padRadius = function(n) {
                return arguments.length ? (i = null == n ? null : "function" == typeof n ? n : vl(+n), t) : i
            }, t.startAngle = function(n) {
                return arguments.length ? (o = "function" == typeof n ? n : vl(+n), t) : o
            }, t.endAngle = function(n) {
                return arguments.length ? (u = "function" == typeof n ? n : vl(+n), t) : u
            }, t.padAngle = function(n) {
                return arguments.length ? (a = "function" == typeof n ? n : vl(+n), t) : a
    ...
    var bl = function(t) {
        ...
        Ml = function() {
            ...
            function n() {
                return wl().defined(u).curve(c).context(a)
            }
            var e = ot,
                r = null,
                i = vl(0),
            ...
            return t.x = function(n) {
                return arguments.length ? (e = "function" == typeof n ? n : vl(+n), r = null, t) : e
            }, t.x0 = function(n) {
                return arguments.length ? (e = "function" == typeof n ? n : vl(+n), t) : e
            }, t.x1 = function(n) {
                return arguments.length ? (r = null == n ? null : "function" == typeof n ? n : vl(+n), t) : r
            }, t.y = function(n) {
                return arguments.length ? (i = "function" == typeof n ? n : vl(+n), o = null, t) : i
            }, t.y0 = function(n) {
                return arguments.length ? (i = "function" == typeof n ? n : vl(+n), t) : i
            }, t.y1 = function(n) {
                return arguments.length ? (o = null == n ? null : "function" == typeof n ? n : vl(+n), t) : o
        ...
        kl = function() {
            function t(t) {
                var a, c, s, f, l, h = t.length,
                    ...
                    y = Math.min(ml, Math.max(-ml, o.apply(this, arguments) - _)),
    ...
    var Al = function() {
        ...
        Cl = {
            draw: function(t, n) {
                var e = Math.sqrt(n / yl);
                t.moveTo(e, 0), t.arc(0, 0, e, 0, ml)
            }
        },
        zl = {
            draw: function(t, n) {
        ...
        Rl = .8908130915292852,
        Ul = Math.sin(yl / 10) / Math.sin(7 * yl / 10),
        Dl = Math.sin(ml / 10) * Ul,
        Ol = -Math.cos(ml / 10) * Ul,
        Fl = {
            draw: function(t, n) {
        ...
        Bl = {
            draw: function(t, n) {
                var e = -Math.sqrt(n / (3 * Yl));
                t.moveTo(0, 2 * e), t.lineTo(-Yl * e, -e), t.lineTo(Yl * e, -e), t.closePath()
            }
        },
        jl = -.5,
        Hl = Math.sqrt(3) / 2,
        ...
        Wl = {
            draw: function(t, n) {
                var e = Math.sqrt(n / Vl),
                    ...
                    a = -o,
                    c = u;
                t.moveTo(r, i), t.lineTo(o, u), t.lineTo(a, c), t.lineTo(jl * r - Hl * i, Hl * r + jl * i), t.lineTo(jl * o - Hl * u, Hl * o + jl * u), t.lineTo(jl * a - Hl * c, Hl * a + jl * c), t.lineTo(jl * r + Hl * i, jl * i - Hl * r), t.lineTo(jl * o + Hl * u, jl * u - Hl * o), t.lineTo(jl * a + Hl * c, jl * c - Hl * a), t.closePath()
            }
        },
        $l = [Cl, zl, Ll, Il, Fl, Bl, Wl],
        Zl = function() {
            function t() {
                var t;
        ...
        lineEnd: function() {
            ...
            if (e)
                if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
                    ...
                    for (var r = Lt(t), i = Lt(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
    ...
    var sh = function(t) {
        ...
        ph = function() {
            ...
            return t.keys = function(e) {
                return arguments.length ? (n = "function" == typeof e ? e : vl(fh.call(e)), t) : n
            }, t.value = function(n) {
                return arguments.length ? (i = "function" == typeof n ? n : vl(+n), t) : i
            }, t.order = function(n) {
                return arguments.length ? (e = null == n ? hh : "function" == typeof n ? n : vl(fh.call(n)), t) : e
            }, t.offset = function(n) {
                return arguments.length ? (r = null == n ? lh : n, t) : r
            }, t
        },
        dh = function(t, n) {
            if ((r = t.length) > 0) {
        ...
        _h = function(t, n) {
            if ((i = t.length) > 0 && (r = (e = t[n[0]]).length) > 0) {
                ...
                e[u - 1][1] += e[u - 1][0] = o, lh(t, n)
            }
        },
        yh = function(t) {
            var n = t.map(Ft);
            return hh(t).sort(function(t, e) {
                return n[t] - n[e]
            })
        },
        gh = function(t) {
        ...
        Th = /^#([0-9a-f]{3})$/,
        Nh = /^#([0-9a-f]{6})$/,
        kh = /^rgb\(\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*\)$/,
        Sh = /^rgb\(\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*\)$/,
        Ah = /^rgba\(\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/,
        Eh = /^rgba\(\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/,
        Ch = /^hsl\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*\)$/,
        zh = /^hsla\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/,
        Ph = {
            aliceblue: 15792383,
    ...
    bh(Yt, Bt, {
        ...
        brighter: function(t) {
            return t = null == t ? Mh : Math.pow(Mh, t), new Wt(this.r * t, this.g * t, this.b * t, this.opacity)
        },
        darker: function(t) {
            return t = null == t ? wh : Math.pow(wh, t), new Wt(this.r * t, this.g * t, this.b * t, this.opacity)
        },
        rgb: function() {
            return this
        },
        ...
        brighter: function(t) {
            return t = null == t ? Mh : Math.pow(Mh, t), new Jt(this.h, this.s, this.l * t, this.opacity)
        },
        darker: function(t) {
            return t = null == t ? wh : Math.pow(wh, t), new Jt(this.h, this.s, this.l * t, this.opacity)
        },
        rgb: function() {
    ...
    bh(nn, tn, It(Yt, {
        brighter: function(t) {
            return new nn(this.l + Rh * (null == t ? 1 : t), this.a, this.b, this.opacity)
        },
        darker: function(t) {
            return new nn(this.l - Rh * (null == t ? 1 : t), this.a, this.b, this.opacity)
        },
        rgb: function() {
            ...
            return t = Dh * rn(t), n = Uh * rn(n), e = Oh * rn(e), new Wt(on(3.2404542 * n - 1.5371385 * t - .4985314 * e), on(-.969266 * n + 1.8760108 * t + .041556 * e), on(.0556434 * n - .2040259 * t + 1.0572252 * e), this.opacity)
        }
    })), bh(sn, cn, It(Yt, {
        brighter: function(t) {
            return new sn(this.h, this.c, this.l + Rh * (null == t ? 1 : t), this.opacity)
        },
        darker: function(t) {
            return new sn(this.h, this.c, this.l - Rh * (null == t ? 1 : t), this.opacity)
        },
    ...
    bh(hn, ln, It(Yt, {
        brighter: function(t) {
            return t = null == t ? Mh : Math.pow(Mh, t), new hn(this.h, this.s, this.l * t, this.opacity)
        },
        darker: function(t) {
            return t = null == t ? wh : Math.pow(wh, t), new hn(this.h, this.s, this.l * t, this.opacity)
        },
        rgb: function() {
            var t = isNaN(this.h) ? 0 : (this.h + 120) * qh,
                n = +this.l,
                e = isNaN(this.s) ? 0 : this.s * n * (1 - n),
                r = Math.cos(t),
                i = Math.sin(t);
            return new Wt(255 * (n + e * (jh * r + Hh * i)), 255 * (n + e * (Xh * r + Vh * i)), 255 * (n + e * (Wh * r)), this.opacity)
        }
    }));
    var Jh, Qh, Kh, tp, np = function(t) {
            var n = t.length - 1;
            return function(e) {
        ...
        fp = function(t, n) {
            ...
            for (e in n) e in t ? r[e] = dp(t[e], n[e]) : i[e] = n[e];
            return function(t) {
        ...
        lp = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
        hp = new RegExp(lp.source, "g"),
        pp = function(t, n) {
            var e, r, i, o = lp.lastIndex = hp.lastIndex = 0,
                u = -1,
                a = [],
                c = [];
            for (t += "", n += "";
                (e = lp.exec(t)) && (r = hp.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
                i: u,
                x: sp(e, r)
            })), o = hp.lastIndex;
        ...
        dp = function(t, n) {
            var e, r = typeof n;
            return null == n || "boolean" === r ? rp(n) : ("number" === r ? sp : "string" === r ? (e = Bt(n)) ? (n = e, ip) : pp : n instanceof Bt ? ip : n instanceof Date ? cp : Array.isArray(n) ? ap : isNaN(n) ? fp : sp)(t, n)
        },
        vp = function(t, n) {
            return t = +t, n -= t,
                function(e) {
        ...
        Np = function(t, n) {
            var e, r, i = t[0],
                ...
                l = c - o,
                h = f * f + l * l;
            if (h < Tp) r = Math.log(s / u) / bp, e = function(t) {
                return [i + t * f, o + t * l, u * Math.exp(bp * t * r)]
            };
            else {
                var p = Math.sqrt(h),
                    d = (s * s - u * u + Mp * h) / (2 * u * wp * p),
                    v = (s * s - u * u - Mp * h) / (2 * s * wp * p),
                    _ = Math.log(Math.sqrt(d * d + 1) - d),
                    y = Math.log(Math.sqrt(v * v + 1) - v);
                r = (y - _) / bp, e = function(t) {
                    var n = t * r,
                        e = Nn(_),
                        a = u / (wp * p) * (e * Sn(bp * n + _) - kn(_));
                    return [i + a * f, o + a * l, u * e / Nn(bp * n + _)]
                }
            }
    ...
    var Lp, Rp, Up = function(t) {
        ...
        $p = function(t, n) {
            return function(e, r) {
                var i = Wp(e).mimeType(t).response(n);
                if (null != r) {
        ...
        Zp = $p("text/html", function(t) {
            return document.createRange().createContextualFragment(t.responseText)
        }),
        Gp = $p("application/json", function(t) {
            return JSON.parse(t.responseText)
        }),
        Jp = $p("text/plain", function(t) {
            return t.responseText
        }),
        Qp = $p("application/xml", function(t) {
            var n = t.responseXML;
        ...
        td = Kp("text/csv", Op),
        nd = Kp("text/tab-separated-values", jp),
        ed = 0,
        rd = 0,
        id = 0,
        od = 1e3,
        ...
        ad = 0,
        cd = 0,
        sd = "object" == typeof performance && performance.now ? performance : Date,
        fd = "function" == typeof requestAnimationFrame ? requestAnimationFrame : function(t) {
            setTimeout(t, 17)
        };
    Xn.prototype = Vn.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            e = (null == e ? jn() : +e) + (null == n ? 0 : +n), this._next || Rp === this || (Rp ? Rp._next = this : Lp = this, Rp = this), this._call = t, this._time = e, Jn()
        },
        stop: function() {
    ...
    var _d = vd.range,
        ...
        Nd = Td.range,
        kd = Qn(function(t) {
            var n = t.getTimezoneOffset() * gd % md;
            n < 0 && (n += md), t.setTime(Math.floor((+t - n) / md) * md + n)
        }, function(t, n) {
            t.setTime(+t + n * md)
        }, function(t, n) {
            return (n - t) / md
        ...
        Ad = Qn(function(t) {
            ...
            return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * gd) / xd
        }, function(t) {
            return t.getDate() - 1
        }),
        Ed = Ad.range,
    ...
    var yv, gv = _v.range,
        ...
        Mv = function(t, n) {
            ...
            var r = e[0],
                i = e[1],
                o = i - (yv = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
                u = r.length;
    ...
    var Av, Ev = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"],
        Cv = function(t) {
            function n(t) {
                function n(t) {
                    var n, i, c, g = d,
                    ...
                    if ("c" === p) m = _(t) + m, t = "";
                        ...
                        if (g = (x ? "(" === a ? a : "-" : "-" === a || "(" === a ? "" : a) + g, m = m + ("s" === p ? Ev[8 + yv / 3] : "") + (x && "(" === a ? ")" : ""), y)
            ...
            var r = t.grouping && t.thousands ? bv(t.grouping, t.thousands) : ee,
                i = t.currency,
                o = t.decimal;
            return {
                format: n,
    ...
    var Fv = "%Y-%m-%dT%H:%M:%S.%LZ",
        Iv = Date.prototype.toISOString ? er : t.utcFormat(Fv),
        Yv = +new Date("2000-01-01T00:00:00.000Z") ? rr : t.utcParse(Fv),
        Bv = Array.prototype,
        jv = Bv.map,
        Hv = Bv.slice,
        Xv = {
        ...
        Zv = function(n, r, i) {
            var o, u = n[0],
                a = n[n.length - 1],
                c = e(u, a, null == r ? 10 : r);
            switch (i = Sv(null == i ? ",f" : i), i.type) {
                case "s":
                    var s = Math.max(Math.abs(u), Math.abs(a));
                    return null != i.precision || isNaN(o = qv(c, s)) || (i.precision = o), t.formatPrefix(i, s);
                case "":
                case "e":
                case "g":
                case "p":
                case "r":
                    null != i.precision || isNaN(o = Lv(c, Math.max(Math.abs(u), Math.abs(a)))) || (i.precision = o - ("e" === i.type));
                    break;
                case "f":
                case "%":
        ...
        r_ = 365 * t_,
        i_ = function() {
            return qr(Vd, Hd, Cd, Ad, kd, Td, wd, vd, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)])
        },
        o_ = function() {
            return qr(_v, dv, tv, Qd, Gd, $d, wd, vd, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)])
        },
        u_ = function(t) {
        ...
        a_ = u_("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
        ...
        l_ = zp(ln(300, .5, 0), ln(-240, .5, 1)),
        h_ = zp(ln(-100, .75, .35), ln(80, 1.5, .8)),
        p_ = zp(ln(260, .75, .35), ln(80, 1.5, .8)),
        d_ = ln(),
        v_ = function(t) {
            (t < 0 || t > 1) && (t -= Math.floor(t));
            var n = Math.abs(t - .5);
            return d_.h = 360 * t - 100, d_.s = 1.5 - 1.5 * n, d_.l = .8 - .9 * n, d_ + ""
        },
        __ = Lr(u_("")),
        ...
        w_ = function(t) {
            var n = t += "",
                e = n.indexOf(":");
            return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), b_.hasOwnProperty(n) ? {
                space: b_[n],
                local: t
            } : t
        },
    ...
    if ("undefined" != typeof document) {
        var k_ = document.documentElement;
        if (!k_.matches) {
            var S_ = k_.webkitMatchesSelector || k_.msMatchesSelector || k_.mozMatchesSelector || k_.oMatchesSelector;
            N_ = function(t) {
                return function() {
                    return S_.call(this, t)
                }
            }
        }
    }
    ...
    if (t.event = null, "undefined" != typeof document) {
        var C_ = document.documentElement;
        "onmouseenter" in C_ || (E_ = {
            mouseenter: "mouseover",
            mouseleave: "mouseout"
        })
    }
    var z_ = function(t, n, e) {
            var r, i, o = Br(t + ""),
                u = o.length; {
                if (!(arguments.length < 2)) {
        ...
        L_ = function(t) {
            var n = P_();
            return n.changedTouches && (n = n.changedTouches[0]), q_(t, n)
        },
        R_ = function(t) {
        ...
        Y_ = function() {
            return new zi(this._enter || this._groups.map(I_), this._parents)
        };
    $r.prototype = {
        constructor: $r,
    ...
    var B_ = function(t) {
        ...
        X_ = function() {
            return new zi(this._exit || this._groups.map(I_), this._parents)
        },
        V_ = function(t) {
        ...
        ry = function(t, n, e) {
            var r;
            return arguments.length > 1 ? this.each((null == n ? ii : "function" == typeof n ? ui : oi)(t, n, null == e ? "" : e)) : ey(r = this.node()).getComputedStyle(r, null).getPropertyValue(t)
        },
        iy = function(t, n) {
    ...
    var oy = function(t, n) {
        ...
        fy = function(t) {
            var n = "function" == typeof t ? t : M_(t);
            return this.select(function() {
                return this.appendChild(n.apply(this, arguments))
            })
        },
        ly = function(t, n) {
            var e = "function" == typeof t ? t : M_(t),
                r = null == n ? ki : "function" == typeof n ? n : R_(n);
            return this.select(function() {
    ...
    var _y = function(t) {
        ...
        yy = function(t) {
            return "string" == typeof t ? new zi([document.querySelectorAll(t)], [document.documentElement]) : new zi([null == t ? [] : t], vy)
        },
        gy = function(t, n, e) {
            arguments.length < 3 && (e = n, n = P_().changedTouches);
            for (var r, i = 0, o = n ? n.length : 0; i < o; ++i)
                if ((r = n[i]).identifier === e) return q_(t, r);
            return null
        },
        my = function(t, n) {
            null == n && (n = P_().touches);
            for (var e = 0, r = n ? n.length : 0, i = new Array(r); e < r; ++e) i[e] = q_(t, n[e]);
            return i
        },
        xy = Pn("start", "end", "interrupt"),
        by = [],
        wy = 0,
        My = 1,
        Ty = 2,
        ...
        Cy = function(t, n) {
            ...
            if (o) {
                n = null == n ? null : n + "";
                for (i in o)(e = o[i]).name === n ? (r = e.state > Ty && e.state < Sy, e.state = Ay, e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i]) : u = !1;
        ...
        qy = function(t, n) {
            var e;
            return ("number" == typeof n ? sp : n instanceof Bt ? ip : (e = Bt(n)) ? (n = e, ip) : pp)(t, n)
        },
        Ly = function(t, n) {
            var e = w_(t),
                r = "transform" === e ? xp : qy;
        ...
        jy = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
                for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Ey(l[h], n, e, h, l, Ri(a, e)));
        ...
        Hy = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = [], u = [], a = 0; a < i; ++a)
                for (var c, s = r[a], f = s.length, l = 0; l < f; ++l)
                    if (c = s[l]) {
                        for (var h, p = t.call(c, c.__data__, l, s), d = Ri(c, e), v = 0, _ = p.length; v < _; ++v)(h = p[v]) && Ey(h, n, e, v, p, d);
                        o.push(p), u.push(c)
                    }
            return new so(o, u, n, e)
        },
        Xy = Pi.prototype.constructor,
        Vy = function() {
            return new Xy(this._groups, this._parents)
        },
        Wy = function(t, n, e) {
            var r = "transform" == (t += "") ? mp : qy;
    ...
    var Ky = {
        ...
        tg = function(t) {
            var n, e;
            t instanceof so ? (n = t._id, t = t._name) : (n = lo(), (e = Ky).time = jn(), t = null == t ? null : t + "");
            for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
                for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)(u = a[s]) && Ey(u, t, n, s, a, e || ho(u, n));
            return new so(r, this._parents, t, n)
        };
    Pi.prototype.interrupt = zy, Pi.prototype.transition = tg;
    var ng = [null],
        eg = function(t, n) {
            ...
            if (i) {
                n = null == n ? null : n + "";
                for (r in i)
                    if ((e = i[r]).state > My && e.name === n) return new so([
                        [t]
                    ], ng, n, +r)
            }
            return null
    ...
    var bg = function(t) {
        ...
        Ng = function() {
            ...
            return t.radius = function(e) {
                ...
                return arguments.length ? (i = "function" == typeof n ? n : Tg(+n), t) : i
            }, t
        },
        kg = function(t) {
        ...
        Ag = function() {
            function t(t) {
                var u = t.height + 1;
                return t.x0 = t.y0 = i, t.x1 = e, t.y1 = r / u, t.eachBefore(n(r, u)), o && t.eachBefore(kg), t
            }

            function n(t, n) {
                return function(e) {
                    e.children && Sg(e, e.x0, t * (e.depth + 1) / n, e.x1, t * (e.depth + 2) / n);
                    var r = e.x0,
                        o = e.y0,
                        u = e.x1 - i,
                        a = e.y1 - i;
        ...
        Pg = function() {
            function t(t) {
                var r, i, o, u, a, c, s, f = t.length,
                    l = new Array(f),
                    h = {};
                for (i = 0; i < f; ++i) r = t[i], a = l[i] = new Uo(r), null != (c = n(r, i, t)) && (c += "") && (s = Eg + (a.id = c), h[s] = s in h ? zg : a);
                for (i = 0; i < f; ++i)
                    if (a = l[i], c = e(t[i], i, t), null != c && (c += "")) {
                        if (u = h[Eg + c], !u) throw new Error("missing: " + c);
                        if (u === zg) throw new Error("ambiguous: " + c);
                ...
                if (o.parent = Cg, o.eachBefore(function(t) {
    ...
    var qg = function() {
        ...
        Dg = function() {
            function t(t) {
                return t.x0 = t.y0 = 0, t.x1 = i, t.y1 = o, t.eachBefore(n), u = [0], r && t.eachBefore(kg), t
            }
            ...
            return t.round = function(n) {
                ...
                return arguments.length ? (a = "function" == typeof n ? n : Tg(+n), t) : a
                ...
                return arguments.length ? (c = "function" == typeof n ? n : Tg(+n), t) : c
            }, t.paddingRight = function(n) {
                return arguments.length ? (s = "function" == typeof n ? n : Tg(+n), t) : s
            }, t.paddingBottom = function(n) {
                return arguments.length ? (f = "function" == typeof n ? n : Tg(+n), t) : f
            }, t.paddingLeft = function(n) {
                return arguments.length ? (l = "function" == typeof n ? n : Tg(+n), t) : l
            }, t
        },
        Og = function(t, n, e, r, i) {
            ...
            function e(t, e, r, i, o) {
                if ((u = t._squarify) && u.ratio === n)
                    for (var u, a, c, s, f, l = -1, h = u.length, p = t.value; ++l < h;) {
                        ...
                        a.dice ? Sg(a, e, r, i, r += (o - r) * a.value / p) : Lg(a, e, r, e += (i - e) * a.value / p, o), p -= a.value
        ...
        Hg = function(t) {
                    ...
                    var a = t.data,
                        ...
                        if (a.index > n) {
                            var v = s - a.x - a.vx,
                                _ = f - a.y - a.vy,
                                y = v * v + _ * _;
                            y < d * d && (0 === v && (v = jg(), y += v * v), 0 === _ && (_ = jg(), y += _ * _), y = (d - (y = Math.sqrt(y))) / y * u, c.vx += (v *= y) * (d = (p *= p) / (h + p)), c.vy += (_ *= y) * d, a.vx -= v * (d = 1 - d), a.vy -= _ * d)
                        }
                    }
                }
                for (var n, r, c, s, f, l, h, p = i.length, d = 0; d < a; ++d)
                    for (r = I(i, hu, pu).visitAfter(e), n = 0; n < p; ++n) c = i[n], l = o[n], h = l * l, s = c.x + c.vx, f = c.y + c.vy, r.visit(t)
            }
            ...
            var i, o, u = 1,
                a = 1;
            return "function" != typeof t && (t = Bg(null == t ? 1 : +t)), n.initialize = function(t) {
                i = t, r()
                ...
                return arguments.length ? (t = "function" == typeof e ? e : Bg(+e), r(), n) : t
            }, n
        },
        Xg = function(t) {
            function n(t) {
            ...
            function e(n) {
                for (var e = 0, r = t.length; e < v; ++e)
                    for (var i, o, u, s, f, h, p, d = 0; d < r; ++d) i = t[d], o = i.source, u = i.target, s = u.x + u.vx - o.x - o.vx || jg(), f = u.y + u.vy - o.y - o.vy || jg(), h = Math.sqrt(s * s + f * f), h = (h - c[d]) / h * n * a[d], s *= h, f *= h, u.vx -= s * (p = l[d]), u.vy -= f * p, o.vx += s * (p = 1 - p), o.vy += f * p
            }
            ...
            function r() {
                if (s) {
                    ...
                    for (n = 0; n < p; ++n) e = t[n], e.index = n, "object" != typeof e.source && (e.source = vu(d, e.source)), "object" != typeof e.target && (e.target = vu(d, e.target)), ++f[e.source.index], ++f[e.target.index];
            ...
            return null == t && (t = []), e.initialize = function(t) {
                ...
                return arguments.length ? (p = "function" == typeof t ? t : Bg(+t), i(), e) : p
            }, e.distance = function(t) {
                return arguments.length ? (d = "function" == typeof t ? t : Bg(+t), u(), e) : d
            }, e
        },
        Vg = 10,
        Wg = Math.PI * (3 - Math.sqrt(5)),
        $g = function(t) {
            function n() {
        ...
        Zg = function() {
            ...
            function r(t, n, e, r) {
                ...
                var i = t.x - o.x,
                    ...
                    h = r - n,
                    p = i * i + c * c;
                if (h * h / l < p) return p < f && (0 === i && (i = jg(), p += i * i), 0 === c && (c = jg(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p), !0;
                if (!(t.length || p >= f)) {
                    (t.data !== o || t.next) && (0 === i && (i = jg(), p += i * i), 0 === c && (c = jg(), p += c * c), p < s && (p = Math.sqrt(s * p)));
            ...
            return t.initialize = function(t) {
                ...
                return arguments.length ? (c = "function" == typeof e ? e : Bg(+e), n(), t) : c
        ...
        Gg = function(t) {
            ...
            var r, i, o, u = Bg(.1);
            return "function" != typeof t && (t = Bg(null == t ? 0 : +t)), n.initialize = function(t) {
                r = t, e()
            }, n.strength = function(t) {
                return arguments.length ? (u = "function" == typeof t ? t : Bg(+t), e(), n) : u
            }, n.x = function(r) {
                return arguments.length ? (t = "function" == typeof r ? r : Bg(+r), e(), n) : t
            }, n
        },
        Jg = function(t) {
            function n(t) {
        ...
        Kg = function(t) {
            var n = t.document.documentElement,
                e = _y(t).on("dragstart.drag", Qg, !0);
            "onselectstart" in n ? e.on("selectstart.drag", Qg, !0) : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none")
        },
        tm = function(t) {
            return function() {
                return t
    ...
    var nm = function() {
            ...
            function e() {
                if (!f && l.apply(this, arguments)) {
                    var n = c("mouse", h.apply(this, arguments), L_, this, arguments);
                    n && (_y(t.event.view).on("mousemove.drag", r, !0).on("mouseup.drag", i, !0), Kg(t.event.view), gu(), s = !1, n("start"))
                }
            }
            ...
            function i() {
                _y(t.event.view).on("mousemove.drag mouseup.drag", null), mu(t.event.view, s), Qg(), d.mouse("end")
            }
            ...
            function o() {
                if (l.apply(this, arguments)) {
                    var n, e, r = t.event.changedTouches,
                        ...
                        o = r.length;
                    for (n = 0; n < o; ++n)(e = c(r[n].identifier, i, gy, this, arguments)) && (gu(), e("start"))
                }
            }
            ...
            function u() {
                var n, e, r = t.event.changedTouches,
                    i = r.length;
                for (n = 0; n < i; ++n)(e = d[r[n].identifier]) && (Qg(), e("drag"))
            }
            ...
            return n.filter = function(t) {
                return arguments.length ? (l = "function" == typeof t ? t : tm(!!t), n) : l
            }, n.container = function(t) {
                return arguments.length ? (h = "function" == typeof t ? t : tm(t), n) : h
            }, n.subject = function(t) {
                return arguments.length ? (p = "function" == typeof t ? t : tm(t), n) : p
            }, n.on = function() {
    ...
    ku.prototype = {
        ...
        insert: function(t, n) {
            ...
            for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;) r = e.U, e === r.L ? (i = r.R, i && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (Au(this, e), t = e, e = t.U), e.C = !1, r.C = !0, Eu(this, r))) : (i = r.L, i && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (Eu(this, e), t = e, e = t.U), e.C = !1, r.C = !0, Au(this, r))), e = t.U;
            this._.C = !1
        },
        remove: function(t) {
    ...
    na.prototype = {
        ...
        triangles: function() {
            ...
            return this.cells.forEach(function(e, r) {
                for (var i, o = e.site, u = e.halfedges, a = -1, c = u.length, s = n[u[c - 1]], f = s.left === o ? s.right : s.left; ++a < c;) i = f, s = n[u[a]], f = s.left === o ? s.right : s.left, r < i.index && r < f.index && Ku(o, i, f) < 0 && t.push([o.data, i.data, f.data])
            }), t
        },
        links: function() {
    ...
    var hm = function() {
            function t(t) {
                return new na(t.map(function(r, i) {
                    var o = [Math.round(n(r, i, t) / fm) * fm, Math.round(e(r, i, t) / fm) * fm];
            ...
            return t.polygons = function(n) {
                ...
                return arguments.length ? (n = "function" == typeof e ? e : em(+e), t) : n
            }, t.y = function(n) {
                return arguments.length ? (e = "function" == typeof n ? n : em(+n), t) : e
            }, t.extent = function(n) {
        ...
        _m = function() {
            ...
            function u(t, n, e) {
                t.on("start.zoom", function() {
                    ...
                    var t = this,
                        ...
                        h = Np(f.invert(c).concat(s / f.k), l.invert(c).concat(s / l.k));
                    return function(t) {
                        if (1 === t) t = l;
                        else {
                            var n = h(t),
            ...
            function s() {
                ...
                if (y.apply(this, arguments)) {
                    ...
                    if (o.wheel) o.mouse[0][0] === s[0] && o.mouse[0][1] === s[1] || (o.mouse[1] = u.invert(o.mouse[0] = s)), clearTimeout(o.wheel);
                        ...
                        if (u.k === c) return;
                        o.mouse = [s, u.invert(s)], Cy(this), o.start()
                    }
                    vm(), o.wheel = setTimeout(n, E), o.zoom("mouse", i(r(e(u, c), o.mouse[0], o.mouse[1]), o.extent))
                }
            }

            function f() {
                function n() {
                    vm(), o.moved = !0, o.zoom("mouse", i(r(o.that.__zoom, o.mouse[0] = L_(o.that), o.mouse[1]), o.extent))
                }

                function e() {
                    u.on("mousemove.zoom mouseup.zoom", null), mu(t.event.view, o.moved), vm(), o.end()
                }
                if (!_ && y.apply(this, arguments)) {
                    var o = a(this, arguments),
                        u = _y(t.event.view).on("mousemove.zoom", n, !0).on("mouseup.zoom", e, !0),
                        c = L_(this);
                    Kg(t.event.view), oa(), o.mouse = [c, this.__zoom.invert(c)], Cy(this), o.start()
                }
            }
            ...
            function l() {
                if (y.apply(this, arguments)) {
                    ...
                    vm(), N > 0 ? _y(this).transition().duration(N).call(u, f, a) : _y(this).call(n.transform, f)
                }
            }
            ...
            function h() {
                if (y.apply(this, arguments)) {
                    var n, e, r, i = a(this, arguments),
                        ...
                        u = o.length;
                    for (oa(), n = 0; n < u; ++n) e = o[n], r = gy(this, o, e.identifier), r = [r, this.__zoom.invert(r), e.identifier], i.touch0 ? i.touch1 || (i.touch1 = r) : i.touch0 = r;
            ...
            function p() {
                var n, o, u, c, s = a(this, arguments),
                    ...
                    l = f.length;
                for (vm(), v && (v = clearTimeout(v)), n = 0; n < l; ++n) o = f[n], u = gy(this, f, o.identifier), s.touch0 && s.touch0[2] === o.identifier ? s.touch0[0] = u : s.touch1 && s.touch1[2] === o.identifier && (s.touch1[0] = u);
            ...
            return n.transform = function(t, n) {
                ...
                return arguments.length ? (y = "function" == typeof t ? t : pm(!!t), n) : y
            }, n.extent = function(t) {
                return arguments.length ? (g = "function" == typeof t ? t : pm([
                    [+t[0][0], +t[0][1]],
                    [+t[1][0], +t[1][1]]
                ]), n) : g
        ...
        Fm = function() {
            function t(t) {
                ...
                for (e && p.sort(function(t, n) {
                    ...
                    }), o = Om(0, Dm - n * l) / o, c = o ? n : Dm / l, u = 0, s = -1; ++s < l;) {
                    for (a = u, f = -1; ++f < l;) {
                        var g = p[s],
                            m = d[g][f],
                            x = t[g][m],
        ...
        Bm = function() {
            function t() {
                var t, a = Im.call(arguments),
                    ...
                    _ = i.apply(this, a) - Um,
                    y = o.apply(this, a) - Um;
                if (u || (u = t = L()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === y || (u.quadraticCurveTo(0, 0, v * qm(_), v * Lm(_)), u.arc(0, 0, v, _, y)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t) return u = null, t + "" || null
            }
            var n = xa,
                e = ba,
                r = wa,
            ...
            return t.radius = function(n) {
                return arguments.length ? (r = "function" == typeof n ? n : Ym(+n), t) : r
            }, t.startAngle = function(n) {
                return arguments.length ? (i = "function" == typeof n ? n : Ym(+n), t) : i
            }, t.endAngle = function(n) {
                return arguments.length ? (o = "function" == typeof n ? n : Ym(+n), t) : o
            }, t.source = function(e) {
                return arguments.length ? (n = e, t) : n
            }, t.target = function(n) {
                return arguments.length ? (e = n, t) : e
    ...
    Na.prototype = {
        ...
        add: function(t) {
            ka(bx, t, this.t), ka(this, bx.s, this.s), this.s ? this.t += bx.t : this.s = bx.t
        },
        valueOf: function() {
            return this.s
        }
    };
    var Hm, Xm, Vm, Wm, $m, Zm, Gm, Jm, Qm, Km, tx, nx, ex, rx, ix, ox, ux, ax, cx, sx, fx, lx, hx, px, dx, vx, _x, yx, gx, mx, xx, bx = new Na,
        wx = 1e-6,
        Mx = 1e-12,
        Tx = Math.PI,
        Nx = Tx / 2,
        ...
        jx = {
            ...
            MultiPolygon: function(t, n) {
                for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) qa(e[r], n)
            },
        ...
        Hx = function(t, n) {
            t && Bx.hasOwnProperty(t.type) ? Bx[t.type](t, n) : za(t, n)
        },
        Xx = jm(),
        Vx = jm(),
        Wx = {
            ...
            lineEnd: Ca,
            polygonStart: function() {
                Xx.reset(), Wx.lineStart = La, Wx.lineEnd = Ra
            },
            polygonEnd: function() {
                var t = +Xx;
                Vx.add(t < 0 ? Sx + t : t), this.lineStart = this.lineEnd = this.point = Ca
            },
            sphere: function() {
                Vx.add(Sx)
            }
        ...
        Gx = {
            ...
            lineEnd: $a,
            polygonStart: function() {
                Gx.point = Za, Gx.lineStart = Ga, Gx.lineEnd = Ja, Zx.reset(), Wx.polygonStart()
            },
            polygonEnd: function() {
                Wx.polygonEnd(), Gx.point = Xa, Gx.lineStart = Wa, Gx.lineEnd = $a, Xx < 0 ? (Zm = -(Jm = 180), Gm = -(Qm = 90)) : Zx > wx ? Qm = 90 : Zx < -wx && (Gm = -90), ix[0] = Zm, ix[1] = Jm
            }
        },
        Jx = function(t) {
            var n, e, r, i, o, u, a;
            if (Qm = Jm = -(Zm = Gm = 1 / 0), rx = [], Hx(t, Gx), e = rx.length) {
                for (rx.sort(Ka), n = 1, r = rx[0], o = [r]; n < e; ++n) i = rx[n], tc(r, i[0]) || tc(r, i[1]) ? (Qa(r[0], i[1]) > Qa(r[0], r[1]) && (r[1] = i[1]), Qa(i[0], r[1]) > Qa(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
                for (u = -(1 / 0), e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n) i = o[n], (a = Qa(r[1], i[0])) > u && (u = a, Zm = i[0], Jm = r[1])
            }
            return rx = ix = null, Zm === 1 / 0 || Gm === 1 / 0 ? [
                [NaN, NaN],
                [NaN, NaN]
            ] : [
                [Zm, Gm],
        ...
        Qx = {
            ...
            lineEnd: uc,
            polygonStart: function() {
                Qx.lineStart = ac, Qx.lineEnd = cc
            },
            polygonEnd: function() {
                Qx.lineStart = rc, Qx.lineEnd = uc
            }
        },
        Kx = function(t) {
            ox = ux = ax = cx = sx = fx = lx = hx = px = dx = vx = 0, Hx(t, Qx);
            var n = px,
                e = dx,
                r = vx,
                i = n * n + e * e + r * r;
            return i < Mx && (n = fx, e = lx, r = hx, ux < wx && (n = ax, e = cx, r = sx), i = n * n + e * e + r * r, i < Mx) ? [NaN, NaN] : [Px(e, n) * Ax, Aa(r / Ix(i)) * Ax]
        },
        tb = function(t) {
            return function() {
                return t
    ...
    lc.invert = lc;
    var eb, rb, ib, ob, ub, ab, cb, sb, fb, lb, hb, pb = function(t) {
            function n(n) {
                return n = t(n[0] * Ex, n[1] * Ex), n[0] *= Ax, n[1] *= Ax, n
            }
            return t = hc(t[0] * Ex, t[1] * Ex, t.length > 2 ? t[2] * Ex : 0), n.invert = function(n) {
                return n = t.invert(n[0] * Ex, n[1] * Ex), n[0] *= Ax, n[1] *= Ax, n
            }, n
        },
        db = function() {
            function t(t, n) {
                e.push(t = r(t, n)), t[0] *= Ax, t[1] *= Ax
            }

            function n() {
                var t = i.apply(this, arguments),
                    n = o.apply(this, arguments) * Ex,
                    c = u.apply(this, arguments) * Ex;
                return e = [], r = hc(-t[0] * Ex, -t[1] * Ex, 0).invert, _c(a, n, c, 1), t = {
                    type: "Polygon",
                    coordinates: [e]
                }, e = r = null, t
            }
            ...
            return n.center = function(t) {
                return arguments.length ? (i = "function" == typeof t ? t : tb([+t[0], +t[1]]), n) : i
            }, n.radius = function(t) {
                return arguments.length ? (o = "function" == typeof t ? t : tb(+t), n) : o
            }, n.precision = function(t) {
                return arguments.length ? (u = "function" == typeof t ? t : tb(+t), n) : u
            }, n
        },
        vb = function() {
            var t, n = [];
        ...
        yb = function(t, n) {
            return Cx(t[0] - n[0]) < wx && Cx(t[1] - n[1]) < wx
        },
        gb = function(t, n, e, r, i) {
            var o, u, a = [],
                c = [];
        ...
        Ab = function() {
            ...
            function n() {
                return Us(Lx(o / _) * _, i, _).map(h).concat(Us(Lx(s / y) * y, c, y).map(p)).concat(Us(Lx(r / d) * d, e, d).filter(function(t) {
                    return Cx(t % _) > wx
                }).map(f)).concat(Us(Lx(a / v) * v, u, v).filter(function(t) {
                    return Cx(t % y) > wx
                }).map(l))
            }
            ...
            var e = t[0] * Ex,
                ...
                _ = d ? function(t) {
                    var n = Ox(t *= d) / v,
                        ...
                        i = e * l + n * p,
                        o = e * a + n * s;
                    return [Px(i, r) * Ax, Px(o, Ix(r * r + i * i)) * Ax]
                } : function() {
                    return [e * Ax, r * Ax]
                };
        ...
        qb = {
            ...
            lineEnd: Ca,
            polygonStart: function() {
                qb.lineStart = Sc, qb.lineEnd = Cc
            },
            polygonEnd: function() {
                qb.lineStart = qb.lineEnd = qb.point = Ca, zb.add(Cx(Pb)), Pb.reset()
            },
            result: function() {
                var t = zb / 2;
                return zb.reset(), t
        ...
        $b = {
            ...
            lineEnd: Uc,
            polygonStart: function() {
                $b.lineStart = Dc, $b.lineEnd = Oc
            },
            polygonEnd: function() {
                $b.point = Pc, $b.lineStart = qc, $b.lineEnd = Uc
            },
            result: function() {
                var t = Wb ? [Xb / Wb, Vb / Wb] : Hb ? [Bb / Hb, jb / Hb] : Yb ? [Fb / Yb, Ib / Yb] : [NaN, NaN];
                return Fb = Ib = Yb = Bb = jb = Hb = Xb = Vb = Wb = 0, t
            }
        };
    Yc.prototype = {
        _radius: 4.5,
        ...
        point: function(t, n) {
            switch (this._point) {
                ...
                case 1:
                    ...
                    break;
                default:
                    this._context.moveTo(t + this._radius, n), this._context.arc(t, n, this._radius, 0, Sx)
            }
        },
        result: Ca
    }, Bc.prototype = {
    ...
    var Zb = function() {
            function t(t) {
                return t && ("function" == typeof o && i.pointRadius(+o.apply(this, arguments)), Hx(t, e(i))), i.result()
            }
            var n, e, r, i, o = 4.5;
            return t.area = function(t) {
                return Hx(t, e(qb)), qb.result()
            }, t.bounds = function(t) {
                return Hx(t, e(Ob)), Ob.result()
            }, t.centroid = function(t) {
                return Hx(t, e($b)), $b.result()
            }, t.projection = function(r) {
                return arguments.length ? (e = null == (n = r) ? Cb : r.stream, t) : n
            }, t.context = function(n) {
                return arguments.length ? (i = null == (r = n) ? new Bc : new Yc(n), "function" != typeof o && i.pointRadius(o), t) : r
        ...
        Jb = function(t, n) {
            ...
            for (var a = 0, c = t.length; a < c; ++a)
                if (f = (s = t[a]).length)
                    for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + kx, d = Ox(p), v = qx(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
                        var y = s[_],
                            g = y[0],
                            m = y[1] / 2 + kx,
                            x = Ox(m),
                            ...
                            N = T > Tx,
                            k = d * x;
                        if (Gb.add(Px(k * M * Ox(T), v * b + k * qx(T))), o += N ? w + M * Sx : w, N ^ h >= e ^ g >= e) {
                            var S = Ya(Fa(l), Fa(y));
                            Ha(S);
                            var A = Ya(i, S);
                            Ha(A);
            ...
            return function(i, o) {
                ...
                function h() {
                    ...
                    if (v.pop(), p.push(v), v = null, a)
                        ...
                        } else a > 1 && 2 & i && u.push(u.pop().concat(u.shift())), d.push(u.filter(Hc))
                }
                var p, d, v, _ = n(o),
                    y = i.invert(r[0], r[1]),
                    g = vb(),
                    ...
                    b = {
                        ...
                        polygonEnd: function() {
                            b.point = u, b.lineStart = c, b.lineEnd = s, d = Zs(d);
                            var t = Jb(p, y);
                            d.length ? (x || (o.polygonStart(), x = !0), gb(d, Xc, t, e, o)) : t && (x || (o.polygonStart(), x = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), x && (o.polygonEnd(), x = !1), d = p = null
                        },
                        sphere: function() {
            ...
            function i(t) {
                ...
                return {
                    ...
                    point: function(l, h) {
                        var p, d = [l, h],
                            v = r(l, h),
                            _ = c ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? Tx : -Tx), h) : 0;
                        if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (yb(n, p) || yb(d, p)) && (d[0] += wx, d[1] += wx, v = r(d[0], d[1]))), v !== i) f = 0, v ? (t.lineStart(), p = o(d, n), t.point(p[0], p[1])) : (p = o(n, d), t.point(p[0], p[1]), t.lineEnd()), n = p;
                        else if (s && n && c ^ v) {
                            var y;
                        ...
                        }!v || n && yb(n, d) || t.point(d[0], d[1]), n = d, i = v, e = _
                    },
                    lineEnd: function() {
                        i && t.lineEnd(), n = null
                    },
            ...
            function o(t, n, e) {
                ...
                if (!(m < 0)) {
                    ...
                    var S = T - M,
                        A = Cx(S - Tx) < wx,
                        E = A || S < wx;
                    if (!A && k < N && (w = N, N = k, k = w), E ? A ? N + k > 0 ^ b[1] < (Cx(b[0] - M) < wx ? N : k) : N <= b[1] && b[1] <= k : S > Tx ^ (M <= b[0] && b[0] <= T)) {
                        var C = ja(_, (-y + x) / g);
    ...
    var ew = 16,
        rw = qx(30 * Ex),
        iw = function(t, n) {
            return +n ? ns(t, n) : ts(t)
        },
        ow = Zc({
            point: function(t, n) {
                this.stream.point(t * Ex, n * Ex)
            }
        }),
        uw = function() {
            return is(us).scale(155.424).center([0, 33.6442])
        },
        aw = function() {
            return uw().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-.6, 38.7])
        },
        cw = function() {
            function t(t) {
                var n = t[0],
            ...
            var e, r, i, o, u, a, c = aw(),
                s = uw().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
                f = uw().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
                l = {
                    point: function(t, n) {
                        a = [t, n]
                    }
            ...
            return t.invert = function(t) {
                ...
                return e && r === t ? e : e = as([c.stream(r = t), s.stream(t), f.stream(t)])
                ...
                return i = c.translate(t).clipExtent([
                    ...
                    [r - .425 * e + wx, a + .12 * e + wx],
                    [r - .214 * e - wx, a + .234 * e - wx]
                ]).stream(l), u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([
                    [r - .214 * e + wx, a + .166 * e + wx],
                    [r - .115 * e - wx, a + .234 * e - wx]
                ]).stream(l), n()
            }, t.fitExtent = Kc(t), t.fitSize = Qc(t), t.scale(1070)
        },
        sw = cs(function(t) {
            return Ix(2 / (1 + t))
        });
    sw.invert = ss(function(t) {
        return 2 * Aa(t / 2)
    });
    var fw = function() {
            return es(sw).scale(124.75).clipAngle(179.999)
        },
        lw = cs(function(t) {
            return (t = Sa(t)) && t / Ox(t)
        });
    lw.invert = ss(function(t) {
        return t
    });
    var hw = function() {
        return es(lw).scale(79.4188).clipAngle(179.999)
    };
    fs.invert = function(t, n) {
        return [t, 2 * zx(Rx(n)) - Nx]
    };
    var pw = function() {
            return ls(fs).scale(961 / Sx)
        },
        dw = function() {
            return is(ps).scale(109.5).parallels([30, 30])
        };
    ds.invert = ds;
    var vw = function() {
            return es(ds).scale(152.63)
        },
        _w = function() {
            return is(vs).scale(131.154).center([0, 13.9389])
        };
    _s.invert = ss(zx);
    var yw = function() {
        return es(_s).scale(144.049).clipAngle(60)
    };
    ys.invert = ss(Aa);
    var gw = function() {
        return es(ys).scale(249.5).clipAngle(90 + wx)
    };
    gs.invert = ss(function(t) {
        return 2 * zx(t)
    });
    var mw = function() {
        return es(gs).scale(250).clipAngle(142)
    };
    ms.invert = function(t, n) {
        return [-n, 2 * zx(Rx(t)) - Nx]
    };
    var xw = function() {
        var t = ls(ms),
            n = t.center,
